...
/** Secret prompt options. */ export interface SecretOptions extends GenericInputPromptOptions<string, string> {
  keys?: SecretKeys;
  /** Change prompt label. Default is `Secret`. */ label?: string;
  /**
   * If enabled, the input value is hidden, otherwise each character is replaced
   * with a `*`.
   */ hidden?: boolean;
  /** Limit minimum allowed length of the secret. */ minLength?: number;
  /** Limit maximum allowed length of the secret. */ maxLength?: number;
}
/** Secret prompt settings. */ interface SecretSettings extends GenericInputPromptSettings<string, string> {
  label: string;
  hidden: boolean;
  minLength: number;
  maxLength: number;
...
/** Secret prompt keymap. */ export type SecretKeys = GenericInputKeys;
/**
 ...
 */ export declare class Secret extends GenericInput<string, string> {
  ...
  /** Execute the prompt with provided message or options. */ public static prompt(options: string | SecretOptions): Promise<string>;
  /**
  ...
  /** Get input input. */ protected getValue(): string;
}
