...
/** Confirm prompt options. */ export interface ConfirmOptions extends Omit<GenericSuggestionsOptions<boolean, string>, UnsupportedOptions> {
  /** Keymap to assign key names to prompt actions. */ keys?: ConfirmKeys;
  /** Change active label. Default is `Yes`. */ active?: string;
  /** Change inactive label. Default is `No`. */ inactive?: string;
}
/** Confirm prompt settings. */ interface ConfirmSettings extends GenericSuggestionsSettings<boolean, string> {
  active: string;
  inactive: string;
  keys?: ConfirmKeys;
}
/** Confirm prompt keymap. */ export type ConfirmKeys = GenericSuggestionsKeys;
/**
 ...
 */ export declare class Confirm extends GenericSuggestions<boolean, string> {
  ...
  /** Execute the prompt with provided options. */ public static prompt(options: string | ConfirmOptions): Promise<boolean>;
  /**
