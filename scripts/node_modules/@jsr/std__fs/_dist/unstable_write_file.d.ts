import type { WriteFileOptions } from "./unstable_types.js";
/**
 ...
 */ export declare function writeFile(path: string | URL, data: Uint8Array | ReadableStream<Uint8Array>, options?: WriteFileOptions): Promise<void>;
/**
 ...
 * @param options Options to write files. See {@linkcode WriteFileOptions}.
 */ export declare function writeFileSync(path: string | URL, data: Uint8Array, options?: WriteFileOptions): void;
//# sourceMappingURL=unstable_write_file.d.ts.map