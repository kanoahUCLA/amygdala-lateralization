import { type GlobOptions } from "@jsr/std__path/glob-to-regexp";
import { type WalkEntry } from "./_create_walk_entry.js";
export type { GlobOptions, WalkEntry };
/** Options for {@linkcode expandGlob} and {@linkcode expandGlobSync}. */ export interface ExpandGlobOptions extends Omit<GlobOptions, "os"> {
  /**
