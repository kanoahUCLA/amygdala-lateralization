...
import { writeTextFile, writeTextFileSync } from "./unstable_write_text_file.js";
/**
  ...
  if (isDeno) {
    ...
    try {
      ...
      if (!options) {
        ...
        await writeTextFile(tempFilePath, "", {
          mode: 0o600
        });
        return tempFilePath;
      }
 ...
 */ export function makeTempFileSync(options) {
  if (isDeno) {
    ...
    try {
      ...
      if (!options) {
        tempFilePath = join(tmpdir(), randomId());
        writeTextFileSync(tempFilePath, "", {
          mode: 0o600
        });
        return tempFilePath;
      }
...
//# sourceMappingURL=unstable_make_temp_file.js.map