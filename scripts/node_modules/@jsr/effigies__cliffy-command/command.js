...
import { parseFlags, UnknownTypeError, ValidationError as FlagsValidationError } from "@jsr/cliffy__flags";
 ...
 */ export class Command {
  ...
  /*****************************************************************************
   **** SUB HANDLER ************************************************************
   *****************************************************************************/ /** Set command name. Used in auto generated help and shell completions */ name(name) {
    this.cmd._name = name;
    return this;
  }
  /**
  ...
  /** Hide command from help, completions, etc. */ hidden() {
  ...
  /** Get error handler callback function. */ getErrorHandler() {
  ...
  /** Get auto generated command usage. */ getUsage() {
    return this._usage ?? [
