...
/** Options for {@linkcode toReadableStream}. */ export interface ToReadableStreamOptions {
   ...
   * @default {16640}
   */ chunkSize?: number;
  /** The queuing strategy to create the {@linkcode ReadableStream} with. */ strategy?: QueuingStrategy<Uint8Array>;
}
/**
