...
/** Permitted log level names */ export declare const LogLevelNames: LevelName[];
/**
...
/** Returns the stringy log level name provided the numeric log level. */ export declare function getLevelName(level: LogLevel): LevelName;
