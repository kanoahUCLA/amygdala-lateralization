 ...
 */ import * as XML from "@jsr/libs__xml";
import { readBytes } from "./access.js";
function getImageDescription(dataview, littleEndian, IFDsize) {
 ...
 */ export async function parseTIFF(file, OME) {
  ...
  const omexml = await XML.parse(imageDescription || '');
