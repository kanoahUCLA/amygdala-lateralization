export const bidsIssues = {
  ...
  FILENAME_MISMATCH: {
    severity: 'error',
    reason: 'The filename is not formatted correctly. This could result from entity duplication or reordering.'
  },
  JSON_KEY_REQUIRED: {
    severity: 'error',
  ...
  TSV_COLUMN_HEADER_DUPLICATE: {
    severity: 'error',
    reason: 'Two elements in the first row of a TSV are the same. Each column header must be unique.'
  },
  TSV_EQUAL_ROWS: {
    severity: 'error',
  ...
  TSV_VALUE_INCORRECT_TYPE: {
    severity: 'error',
    reason: 'A value in a column did not match the acceptable type for that column headers specified format.'
  },
  TSV_COLUMN_TYPE_REDEFINED: {
    severity: 'warning',
    reason: 'A column required in a TSV file has been redefined in a sidecar file. This redefinition is being ignored.'
  },
  ...
  CITATION_CFF_VALIDATION_ERROR: {
    severity: 'error',
    reason: "The file does not pass validation using the citation.cff standard's schema." + 'https://github.com/citation-file-format/citation-file-format/blob/main/schema-guide.md'
  },
  FILE_READ: {
    severity: 'error',
