import type { Aslcontext, Associations, Bval, Bvec, Channels, Events } from 'jsr:/@bids/schema@~1.1.0/context'
import type { Schema as MetaSchema } from 'jsr:/@bids/schema@~1.1.0/metaschema'
