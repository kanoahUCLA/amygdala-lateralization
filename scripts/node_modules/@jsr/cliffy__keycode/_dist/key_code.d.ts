/** KeyCode object. */ export interface KeyCode {
  /** Key name. */ name?: string;
  /** Key sequence. */ sequence?: string;
  /** Key code. */ code?: string;
  /** Indicates if the ctrl key is pressed. */ ctrl?: boolean;
  /** Indicates if the meta key is pressed. */ meta?: boolean;
  /** Indicates if the shift key is pressed. */ shift?: boolean;
  /** Key string value. */ char?: string;
}
/**
