...
/** Chainable colors instance returned by all ansi escape properties. */ export type ColorsChain = Chainable<typeof stdColors, ExcludedColorMethods> & {
  _stack: Array<ColorMethods>;
};
/** Create new `Colors` instance. */ export type ColorsFactory = () => Colors;
/**
