/** Ring audio bell: `\u0007` */ export declare const bel: "\u0007";
/** Get cursor position. */ export declare const cursorPosition: string;
/**
...
/** Move cursor to first column of current row. */ export declare const cursorLeft: string;
/** Hide cursor. */ export declare const cursorHide: string;
/** Show cursor. */ export declare const cursorShow: string;
/** Save cursor. */ export declare const cursorSave: string;
/** Restore cursor. */ export declare const cursorRestore: string;
/**
...
/** Clear screen. */ export declare const eraseScreen: string;
/**
...
/** Clear current line. */ export declare const eraseLine: string;
/** Clear to line end. */ export declare const eraseLineEnd: string;
/** Clear to line start. */ export declare const eraseLineStart: string;
/**
...
/** Clear the terminal screen. (Viewport) */ export declare const clearScreen: "\u001Bc";
/**
...
/** Image options. */ export interface ImageOptions {
  width?: number;
  height?: number;
