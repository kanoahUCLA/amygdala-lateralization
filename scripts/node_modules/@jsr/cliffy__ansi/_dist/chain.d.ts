/** Chainable ansi escape sequences. */ import type { ImageOptions } from "./ansi_escapes.js";
/** Chainable ansi escape method declarations. */ export interface Chain<TContext extends Chain<TContext>> {
  /** Add text. */ text: (text: string) => TContext;
  toArray: () => Array<string>;
  /** Ring audio bell: `\u0007` */ bel: TContext;
  /** Get cursor position. */ cursorPosition: TContext;
  /**
  ...
  /** Move cursor to first column of current row. */ cursorLeft: TContext;
  /** Hide cursor. */ cursorHide: TContext;
  /** Show cursor. */ cursorShow: TContext;
  /** Save cursor. */ cursorSave: TContext;
  /** Restore cursor. */ cursorRestore: TContext;
  /**
  ...
  /** Clear screen. */ eraseScreen: TContext;
  /**
  ...
  /** Clear current line. */ eraseLine: TContext;
  /** Clear to line end. */ eraseLineEnd: TContext;
  /** Clear to line start. */ eraseLineStart: TContext;
  /**
   * Clear screen and move cursor by n lines up and move cursor to first column.
   * @param count Number of lines.
   */ eraseLines: (count: number) => TContext;
  /** Clear the terminal screen. (Viewport) */ clearScreen: TContext;
  /**
