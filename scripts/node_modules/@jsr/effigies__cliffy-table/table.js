 ...
 */ export class Table extends Array {
   ...
   * @param override  Override existing value.
   */ maxTableWidth(width, override = true) {
   ...
   * @param override  Override existing value.
   */ colRigidity(rigidity, override = true) {
  ...
  /** Get max column width. */ getMaxColWidth() {
    return this.options.maxColWidth;
  }
  /** Get min column width. */ getMinColWidth() {
  ...
  /** Get column by column index. */ getColumn(index) {
