...
import { checkKey, removeKey, retrieveKey, storeKey } from "../worker/transferKey.js";
...
export const specialRemote = new Command().name("special-remote").description("git-annex special remote for uploading or downloading from OpenNeuro").action(async ()=>{
  await annexSpecialRemote();
});
//# sourceMappingURL=special-remote.js.map